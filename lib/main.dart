...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    var pendoKey = 'eyJhbGciOiJSUzI1NiIsImtpZCI6IiIsInR5cCI6IkpXVCJ9..cdSh8M7Vyeo-T-D54FcSAm2BKZLAKVW6GdlgeedRjkTtGLnSb62CX-dNol1BscoPZprzZtxw22TUWP5upOIH-d7K-6Xp2zXNZufIAeQ06OCP_39vyuX5Tz4h4fme0J5YTKEcVFfYbznoYQQsWsYG33LxNvNz6cs_A95KhDIXpsc';    
    ...
    var r = Random();
    uniqueId = String.fromCharCodes(List.generate(16, (index) => r.nextInt(33) + 89));
    final String visitorId = uniqueId ?? 'Unknown ID';
    final String accountId = uniqueId ?? 'Unknown ID';
    final dynamic visitorData = {'Age': '25', 'Country': 'USA', 'nickname': 'phucnh36'};
    final dynamic accountData = {'Tier': '1', 'Size': 'Enterprise'};

    await PendoFlutterPlugin.startSession(visitorId, accountId, visitorData, accountData).then((value) => {
      print("Started")
    });

    await PendoFlutterPlugin.track("Test main", {}).then((value) => {
      print("Track Main")
    });
